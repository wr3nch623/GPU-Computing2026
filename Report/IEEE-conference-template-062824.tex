...
\title{GPU Computing Deliverable 1}

\author{\IEEEauthorblockN{Marco Fagnani}
Student ID: 268172\\
marco.fagnani@studenti.unitn.it\\
...
Sparse matrix Vector Multiplication (SpVM) is a computational kernel of the form $y=Ax$, widely used across multiple computational and engineering applications. 
